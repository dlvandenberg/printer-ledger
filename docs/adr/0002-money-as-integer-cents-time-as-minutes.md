...
0.22c/g), energy (5.5h × 0.09 kWh/h × 28c), per-unit division. Floating point accumulates error
...
- Per-unit cost division truncates. Accepted: sub-cent per unit, and Suggested Price rounds up to
